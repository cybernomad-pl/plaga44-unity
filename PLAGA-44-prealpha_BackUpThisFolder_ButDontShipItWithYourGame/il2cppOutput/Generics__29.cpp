...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_mA8A63DEF6FC88B3577BD34EA0EF3FF0BC5E0604A_gshared (Dictionary_2_t1CE70BDE1240DC2965FE7606E0A153556F877DAF* __this, RuntimeObject* ___0_key, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		RuntimeObject* L_0 = ___0_key;
		bool L_1;
		L_1 = Dictionary_2_IsCompatibleKey_m2A63CCC530EF2A8A0BF57D4663D5DD0C90622968(L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 58));
		if (!L_1)
		{
			goto IL_0030;
		}
...
IL_0009:
	{
		RuntimeObject* L_1 = ___1_value;
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisInputDevice_t882EE3EE8A71D8F5F38BA3F9356A49F24510E8BD_m4E704A666B54AA88F34B9A25DD1EBE5FBB1864C3(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 60));
	}
	try
	{
		{
		...
		try
		{
			int32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m8446BF1A204A1721740D95467B6CEA452FB632CC(__this, L_3, ((*(InputDevice_t882EE3EE8A71D8F5F38BA3F9356A49F24510E8BD*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 61));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
