...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			Dictionary_2_set_Item_mA2202BDF286655851C979A0B3B23BCF1E895379D(__this, L_3, ((*(int32_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 61));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
